...
for($i=0;$i<count($all_abstracts);$i++){
    ...
    {
        echo '
        <a target="_blank" href="abstract_index?abstract_presentation_id='.$all_abstracts[$i]["abstract_no"].'&sayfa=abstract_presentations"">'.$language[13].'</a> 
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
    ...
    if($all_abstracts[$i]["referee_ids"]!= null && is_array(json_decode($all_abstracts[$i]["referee_ids"])))
    {
        ...
        { 
            ...
            <a href="abstract_index?abstract_id='.$all_abstracts[$i]["abstract_no"].'&sayfa=abstract_update">'.$language[16].'</a> 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    
            <a href="abstract_index?abstract_id='.$all_abstracts[$i]["abstract_no"].'&sayfa=abstract_category_update">'.$language[17].'</a> 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    
            <a href="abstract_index?abstract_id='.$all_abstracts[$i]["abstract_no"].'&sayfa=abstract_author_update">'.$language[18].'</a> 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    else
    {
        ...
        {
            echo '
            <a href="abstract_index?abstract_id='.$all_abstracts[$i]["abstract_no"].'&sayfa=abstract_update">'.$language[21].'</a> 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

            <a href="abstract_index?abstract_id='.$all_abstracts[$i]["abstract_no"].'&sayfa=abstract_category_update">'.$language[22].'</a> 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

            <a href="abstract_index?abstract_id='.$all_abstracts[$i]["abstract_no"].'&sayfa=abstract_author_update">'.$language[23].'</a> 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
