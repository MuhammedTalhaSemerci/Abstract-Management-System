...
<div class="contant"> 
    ...
    if($uye_yetki ==1 && $abstract_viewer["edit_request_type"] == $abstract_viewer["edit_request_type1"])
    {
        ...
        $page .= '<br>
        <h4 style="color:red;">Bilim Kurulu Üye Adı: '.$referee_info["uye_adi"]." ".$referee_info["uye_soyadi"].'</h4><br><br>
    ...
    $attribs = ["b","i","sup","sub","strong","span","p"];
        ...
        else
        {
            ...
            $main_author_index_arr = [];
            $other_author_index_arr = [];
                    ...
                    for($a=0;$a<count($abstract_location[$i][1]);$a++)
                    {
                        ...
                        if(($abstract_all_authors[$k][0] == $abstract_location[$i][1][$a][0] && $abstract_all_authors[$k][1] == $abstract_location[$i][1][$a][1]))
                        {
                            ...
                            if($i == 0 && $a ==0){
                                ...
                                if($abstract_all_authors[0][4])
                                {
                                    if($abstract_all_authors[0][4]>1)
                                    {
                                        array_push($main_author_index_arr,", <u>".$toplu_str." ".$toplu_str1.'<sup>'.($i+1).'</sup> </u>',$abstract_all_authors[$k][4]);
                                    }
                                    else
                                    {
                                        array_push($main_author_index_arr,"<u>".$toplu_str." ".$toplu_str1.'<sup>'.($i+1).'</sup></u> ',$abstract_all_authors[$k][4]);
                                ...
                                {
                                    array_push($main_author_index_arr,"<u>".$toplu_str." ".$toplu_str1.'<sup>'.($i+1).'</sup></u>',1);
                                }
                            ...
                            else
                            {
                                if($abstract_all_authors[0][4])
                                {
                                    if($abstract_all_authors[0][4]>1)
                                    {
                                        if($i > 1)
                                        {
                                            array_push($other_author_index_arr,", ".$toplu_str." ".$toplu_str1.'<sup>'.($i+1).'</sup> ');                                   
                                        }
                                       else
                                        {
                                            array_push($other_author_index_arr,$toplu_str." ".$toplu_str1.'<sup>'.($i+1).'</sup> ');                                   
            ...
            array_splice($other_author_index_arr,intval($main_author_index_arr[1])-1,0,$main_author_index_arr[0]);
           
           
            for($i=1;$i<count($other_author_index_arr)+1;$i++)
            {
                
                $page .= $other_author_index_arr[$i-1];
            ...
            $page .= '<p class="italic"> '.$language[2].' '.$abstract_main_author[3].'</p>';
        }
        ...
        {
            $turkish_contant = $abstract_viewer["contant"];
            $turkish_contant = strip_tags($turkish_contant,$attribs);
        ...
        if($turkish_keywords && $abstract_viewer["edit_requests"])
        {
            ...
            {
                if($turkish_keywords[$i] != "" && $turkish_keywords[$i] != null)
                {
                    $cakisma = 0;
                    $key_edit_index;
                    $key_edit_sentences = json_decode($abstract_viewer["edit_requests"]);
    ...
    if($abstract_viewer["contant_english"] !="" || $abstract_viewer["contant_english"] != null)
    {
        ...
        {
            $english_contant = $abstract_viewer["contant_english"];
            $english_contant = strip_tags($english_contant,$attribs);
    ...
    if( $abstract_viewer["keywords_english"] != "" || $abstract_viewer["keywords_english"] != null)
    {
        ...
        if($english_keywords && $abstract_viewer["edit_requests"])
        {
            ...
            {
                if($english_keywords[$i] != "" && $english_keywords[$i] != null)
                {
                        $key_edit_index;
                        $cakisma = 0;
                        $key_edit_sentences = json_decode($abstract_viewer["edit_requests"]);
