...
if(isset($_GET["sayfa"])){
  ...
  if($_GET["sayfa"] == "abstracts_all_author_infos"){

    include(__DIR__."/abstracts_all_author_infos.php");
  ...
  if($_GET["sayfa"] == "all_users_mails"){

    include(__DIR__."/all_users_mails.php");

  }
  
  if($_GET["sayfa"] == "scientific_program"){

    include(__DIR__."/scientific_program.php");
  ...
  if($_GET["sayfa"] == "virtual_congress_pages"){

    include(__DIR__."/virtual_congress_pages.php");


  }
  
  if($_GET["sayfa"] == "all_bbb_sessions"){

    include(__DIR__."/all_bbb_sessions.php");


  }

  if($_GET["sayfa"] == "live_stream_chat_app_permission"){

    include(__DIR__."/live_stream_chat_app_permission.php");
  }
