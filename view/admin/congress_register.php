 ...
 <table><caption></caption></table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td align="center"><?php echo $prices->{$uye_dil}->{"ogrenci"}[0].$prices->{$uye_dil}->{"currency"};?> <input class="hsp" type="radio" name="Kayit_ucreti" value="Öğrenci Kaydı/<?php echo $prices->{$uye_dil}->{"ogrenci"}[0];?>/Erken Kayıt<?php echo $language[9];?>" <?php if(date('U') <= $abstract_websites[0]["registration_time_limit"]){echo "required";}else{echo 'disabled="disabled"';}?>></td>
                  <td align="center"><?php echo $prices->{$uye_dil}->{"ogrenci"}[1].$prices->{$uye_dil}->{"currency"};?> <input class="hsp" type="radio" name="Kayit_ucreti" value="Öğrenci Kaydı/<?php echo $prices->{$uye_dil}->{"ogrenci"}[1];?>/Geç Kayıt<?php echo $language[12];?>" <?php if(date('U') <= $abstract_websites[0]["registration_time_limit"]){echo 'disabled="disabled"';}else{echo "required";}?>></td>
                </tr>
                <tr>
                  <td><strong> &nbsp;&nbsp;<?php echo $language[13];?></strong></td>
                  <td align="center"><?php echo $prices->{$uye_dil}->{"normal"}[0].$prices->{$uye_dil}->{"currency"};?> <input class="hsp" type="radio" name="Kayit_ucreti" value="Normal Kayıt/<?php echo $prices->{$uye_dil}->{"normal"}[0];?>/Erken Kayıt<?php echo $language[16];?>" <?php if(date('U') <= $abstract_websites[0]["registration_time_limit"]){echo "required";}else{echo 'disabled="disabled"';}?>></td>
                  <td align="center"><?php echo $prices->{$uye_dil}->{"normal"}[1].$prices->{$uye_dil}->{"currency"};?> <input class="hsp" type="radio" name="Kayit_ucreti" value="Normal Kayıt/<?php echo $prices->{$uye_dil}->{"normal"}[1];?>/Geç Kayıt<?php echo $language[19];?>" <?php if(date('U') <= $abstract_websites[0]["registration_time_limit"]){echo 'disabled="disabled"';}else{echo "required";}?>></td>
                </tr>
                <tr>
                  <td><strong> &nbsp;&nbsp;<?php echo $language[20];?></strong></td>
                  <td align="center"><?php echo $prices->{$uye_dil}->{"katilimci"}[0].$prices->{$uye_dil}->{"currency"};?> <input class="hsp" type="radio" name="Kayit_ucreti" value="Katılımcı Kaydı/<?php echo $prices->{$uye_dil}->{"katilimci"}[0];?>/Erken Kayıt<?php echo $language[23];?>" <?php if(date('U') <= $abstract_websites[0]["registration_time_limit"]){echo "required";}else{echo 'disabled="disabled"';}?>></td>
                  <td align="center"><?php echo $prices->{$uye_dil}->{"katilimci"}[1].$prices->{$uye_dil}->{"currency"};?> <input class="hsp" type="radio" name="Kayit_ucreti" value="Katılımcı Kaydı/<?php echo $prices->{$uye_dil}->{"katilimci"}[1];?>/Geç Kayıt<?php echo $language[26];?>" <?php if(date('U') <= $abstract_websites[0]["registration_time_limit"]){echo 'disabled="disabled"';}else{echo "required";}?>></td>
                </tr>
              </tbody>
            </table>
